...
class RunConfig:
    ...
    NPE_NUM_STEPS: int = 2000        # training steps
    ...
    NPE_TRIAL_NET_HIDDEN: int = 256  # per-trial MLP width 
    NPE_TRIAL_NET_LAYERS: int = 4    # per-trial MLP depth
    NPE_TRIAL_NET_OUTPUT_DIM: int = 128  # per-trial embedding dim
    NPE_AGG_FN: str = "mean"
